...
export const Sidebar = () => {
    ...
    <div>
      ...
      <aside className="fixed w-0 h-full bg-blue-500 sm:w-[14rem] sm:block overflow-y-auto transition-transform duration-300 ease-in-out transform sm:translate-x-0 -translate-x-full sm:duration-300">
        <div className="px-4 pb-8 pt-2 flex flex-row flex-start gap-2 ">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-white size-14">
                <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349M3.75 21V9.349m0 0a3.001 3.001 0 0 0 3.75-.615A2.993 2.993 0 0 0 9.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 0 0 2.25 1.016c.896 0 1.7-.393 2.25-1.015a3.001 3.001 0 0 0 3.75.614m-16.5 0a3.004 3.004 0 0 1-.621-4.72l1.189-1.19A1.5 1.5 0 0 1 5.378 3h13.243a1.5 1.5 0 0 1 1.06.44l1.19 1.189a3 3 0 0 1-.621 4.72M6.75 18h3.75a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H6.75a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Z" />
                </svg>
            </div>
            <div className="flex flex-row justify-between w-0 sm:w-60">
                <div>
                    <h3 className="text-white font-bold">Chandru </h3>
                    <h4 className="underline text-gray-300">visit Store</h4>
                </div>
                <div>
        ...
        <div className="mx-3 my-2 h-10 rounded-lg hover:bg-blue-300 hover:text-white flex flex-row flex-start gap-2 items-center text-gray-300">
            <div className="pl-2 pl-1 ">
        ...
        <div className="flex flex-col  h-[14rem] justify-end mx-4 mb-3">
            <div className="flex flex-row items-center px-2 bg-blue-300 py-2 rounded-md gap-2">
                <div className="bg-blue-300 text-white p-1 rounded-md border">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 0 0-2.25-2.25H15a3 3 0 1 1-6 0H5.25A2.25 2.25 0 0 0 3 12m18 0v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 9m18 0V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v3" />
                </svg>
                </div>
                <div className="text-gray-300 hover:text-white">
                    <div className="text-sm">Availabel Credit</div>
                    <div>222.10</div>
                </div>
            </div>
        </div>
